...
//главное меню сайта
    $main_menu = array(
        ...
        'Наши услуги' => array(
            'Web дизайн' => 'dezign',
            'Web разработка' => 'razrabotka-sayta',
            'SEO оптимизация' => 'prodvizhenie-sayta',
            'Контент услуги' => 'napolnenie-sayta',
            'Сбор семантического ядра' => 'sbor-semanticheskoga-yadra',
            'Аудит и сопровождение сайтов' => 'soprovozhdenie-sayta',
        ),
        'Портфолио' => 'portfolio',
        'Блог' => 'blog',
        'Контакты' => 'contact',
...
//мультисервис НАЧАЛО
    $service_tabs_v2 = array(
        'header' => 'Почему мы?',
        'text1' => 'Наше преимущество - опыт и не высокие цены на наши услуги',
        'text2' => 'Благодаря огромному опыту наших специалистов, мы готовы предложить вам высококачественные услуги в области web разработки, дизайна, семантического анализа и поисковой оптимизации. Вы также можете обратится к нам за бесплатной консультацией по существующим проектам',
    ...
    $_service_items_v2 = array(
        ...
        'seo2' => array(
            ...
            'btn_url' => 'sbor-semanticheskoga-yadra',
        ),
        'seo_text3' => array(
            'img' => '06.png',
...
//мультисервис КОНЕЦ
    ...
    $about_us = array(
        'header' => 'О НАС',
        'description' => 'Наша компания специализируется на современных решениях для бизнесса в области вэб разработки, поисковой оптимизации и техническом сопровождении проектов',
);
    $useful_links = array(
        'Web дизайн' => 'dezign',
        'Web разработка' => 'razrabotka-sayta',
