...
$portfolio_items = array(
    'vecherya-soloha' => array(
        ...
        'header' => 'Сайт ресторана',
        'description' => 'Разработка сайта для ресторана "Корчма Вечеря у Солохи" CMS WordPress, адаптивная верстка на bootstrap 4',
        'url' => 'vecherya-soloha.ru',
//        'dezign' => 'Дизайн',
...
//        'upwork' => 'Upwork projects',
    ...
    'instrument-ekat' => array(
        ...
        'description' => 'Собственная CMS для лэндингов, адаптивный дизайн. SEO подготовка, настройка рекламы в Яндекс Директ. Возможность расширения до полноценного каталога без смены CMS',
        'url' => 'instrument-ekat.ru',
    ),
    'pelemeshka-ekb' => array(
        ...
        'header' => 'Кафе "Время Есть"',
        'description' => 'Сайт на CMS Wordpress, фреймворк Bootstrap 4, адаптивный дизайн, верстка по макету клиента, поисковая оптимизация, поддержка сайта',
        'url' => 'pelemeshka-ekb.ru',
    ),
    '4elementstobacco' => array(
        ...
        'header' => 'Сайт "4 elements"',
        'description' => 'Сайт на CMS Wordpress, фреймворк Bootstrap 4, адаптивный дизайн, доработка стандартного шаблона под нужды заказчика. Срочная разработка с upwork.com, период разработки 6 часов',
        'url' => '4elementstobacco.eu',
    ),
    'air-parking' => array(
        'url_link_button' => '#',
        'name_button' => 'Подробнее',
