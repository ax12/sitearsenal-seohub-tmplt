<?php require_once 'get_lang_and_locations_inc.php'; //определяем язык или локацию ?>
<?php require_once 'style_scripts_header_inc.php' // connect css files?>
<?php require_once 'site_settings_array.php' // connect settings arrays?>
<div class="topbar">
            ...
            <div class="col-md-4 col-12 float-right d-flex ">
                <div class="topbar-left text-left text-md-left text-light pl-4 ">
                    ...
                    <div class="float-left mx-lineheight-top-bar"><a class="text-light"
                        ...
                        <br> <span class="mx-adress-topbar white"><?php echo $main_contacts[ekb][address]. ', тел.' . $main_contacts[ekb][phone]; ?></span>
                    </div>
                </div>
            </div>
